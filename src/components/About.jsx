    ...
    <section className="bg-[#ff2a2a] pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-white mt-8 md:mt-0 relative z-20">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-black mb-4 uppercase tracking-tighter">About Me</h2>
          <div className="space-y-6">
            <p className="text-lg font-bold leading-relaxed max-w-3xl text-red-50">
              Hi, I'm <span className="text-black text-xl font-black mx-1 tracking-wide uppercase">Aayush Mishra</span>, a final year B.Tech IT student at St. John College of Engineering and Management, Mumbai.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-10">
            {[
              "Software Engineering", "Quantitative Research", "Artificial Intelligence",
              "Workflow Automation", "Cybersecurity", "Financial Markets"
            ].map((focus) => (
              <div key={focus} className="bg-white/10 px-4 py-2 rounded-lg border border-white/20 text-xs font-bold uppercase tracking-wider text-center">
                {focus}
              </div>
            ))}
          </div>
